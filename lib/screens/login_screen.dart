...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Get the device’s screen width so we can adjust layout for mobile/desktop
    ...
    return Scaffold(
      ...
      body: Center(
        child: Container(
             // Make the login box responsive wide on desktop, small on mobile
...
class _LoginFormState extends State<LoginForm> {
  ...
  bool _isButtonEnabled = false; // For button to be disabled when blank

  @override
  void initState() {
    super.initState();
    // Listeners to check when both fields have input
  ...
  Future<void> _login() async {
    setState(() {
     ...
     // Check login credentials with AuthService
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: (_isButtonEnabled && _isLoading == false) ? _login : null, // New line
